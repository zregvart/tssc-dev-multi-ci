...
export GIT_CLONE_PARAM_REVISION=
export GIT_CLONE_PARAM_REFSPEC=
export GIT_CLONE_PARAM_SUBMODULES=
export GIT_CLONE_PARAM_DEPTH=
export GIT_CLONE_PARAM_SSLVERIFY=
export GIT_CLONE_PARAM_SUBDIRECTORY=
export GIT_CLONE_PARAM_SPARSECHECKOUTDIRECTORIES=
export GIT_CLONE_PARAM_DELETEEXISTING=
export GIT_CLONE_PARAM_HTTPPROXY=
export GIT_CLONE_PARAM_HTTPSPROXY=
export GIT_CLONE_PARAM_NOPROXY=
export GIT_CLONE_PARAM_VERBOSE=
export GIT_CLONE_PARAM_GITINITIMAGE=
export GIT_CLONE_PARAM_USERHOME=
export GIT_CLONE_PARAM_ENABLESYMLINKCHECK=
export GIT_CLONE_PARAM_FETCHTAGS=
export GIT_CLONE_PARAM_CATRUSTCONFIGMAPNAME=
export GIT_CLONE_PARAM_CATRUSTCONFIGMAPKEY=
