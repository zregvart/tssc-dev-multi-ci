...
# Parameters 
export PARAM_URL=
export PARAM_REVISION=
export PARAM_REFSPEC=
export PARAM_SUBMODULES=
export PARAM_DEPTH=
export PARAM_SSLVERIFY=
export PARAM_SUBDIRECTORY=
export PARAM_SPARSECHECKOUTDIRECTORIES=
export PARAM_DELETEEXISTING=
export PARAM_HTTPPROXY=
export PARAM_HTTPSPROXY=
export PARAM_NOPROXY=
export PARAM_VERBOSE=
export PARAM_GITINITIMAGE=
export PARAM_USERHOME=
export PARAM_ENABLESYMLINKCHECK=
export PARAM_FETCHTAGS=
export PARAM_CATRUSTCONFIGMAPNAME=
export PARAM_CATRUSTCONFIGMAPKEY=
