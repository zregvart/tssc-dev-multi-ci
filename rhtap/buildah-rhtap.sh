...
export BUILDAH_RHTAP_PARAM_DOCKERFILE=
export BUILDAH_RHTAP_PARAM_CONTEXT=
export BUILDAH_RHTAP_PARAM_TLSVERIFY=
export BUILDAH_RHTAP_PARAM_BUILD_ARGS=
export BUILDAH_RHTAP_PARAM_BUILD_ARGS_FILE=
